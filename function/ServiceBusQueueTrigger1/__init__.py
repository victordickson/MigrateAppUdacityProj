...
def main(msg: func.ServiceBusMessage):
    ...
    try:
        ...
        db_conn = psycopg2.connect(host="proj3server.postgres.database.azure.com", database="techconfdb", user="adminproj3@proj3server.postgres.database.azure.com", password="")
